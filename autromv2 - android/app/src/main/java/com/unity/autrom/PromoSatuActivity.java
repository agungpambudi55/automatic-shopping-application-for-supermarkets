...
public class PromoSatuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promo_satu);
        setTitle("Promo");
        ...
        btn_lokasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(PromoSatuActivity.this, MapProductActivity.class);
                i.putExtra("blok", "D");
                i.putExtra("sekat", "2");
                startActivity(i);
            }
