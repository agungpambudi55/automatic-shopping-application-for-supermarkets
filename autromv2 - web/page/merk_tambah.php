...
<?php
if(!isset($_GET['nama'])){?>
<div id="title_page">TAMBAH MERK</div>
<?php
}
...
if(isset($_GET['nama'])){
	...
	$qrysimpan = que("INSERT INTO `db_autrom`.`tb_merk` (`id_merk`, `nama_merk`) VALUES (NULL, '$nama');");	
	if($qrysimpan)
