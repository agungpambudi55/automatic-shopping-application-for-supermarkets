...
<div id="title_page">DATA LOKASI</div>
<?php
$querytotal	= que("SELECT * FROM tb_lokasi");
...
$qry = que("SELECT * FROM tb_lokasi ORDER BY lokasi_block ASC ".$limit);
...
<div id="control_data">
  ...
  <div id="pg_control">
	...
	{?> <img id="prev" class="btn" src="style/prev.png" width="25" height="25" title="Halaman Sebelumnya" 
    				   onClick="halaman('page/lokasi_view.php?page=<?php echo $curpage-1; ?>')"/> <?php }
	else
	{?> <img id="prev" src="style/prevd.png" width="25" height="25" title="Halaman Sebelumnya Tidak Ada" /> <?php } ?>	
	
	<select title="Pilih Halaman" onchange="halaman('page/lokasi_view.php?page='+this.value)"><?php
	for($r=1; $r <= $jumpage ; $r++){	
		if($curpage == $r)
  ...
  <img id="delall" class="btn" src="style/delall.png" width="25" height="25" title="Hapus Data Yang Dicentang"
  	   onclick="tanya('page/lokasi_hapus.php');" /> </div>

  <img id="tambah" class="btn" src="style/add.png" width="25" height="25" title="Tambah Data"
  	   onclick="halaman('page/lokasi_tambah.php');" /> </div>
</div>
...
<table width="100%" cellspacing="0"  style="border:1px solid #025b9b;">
  <tr id="t_header">
      ...
      <th width='45%' align="left" style="color:#FFF;">Nama Blok</th>
      <th width='45%' align="left" style="color:#FFF;">Jumlah Sekat</th>
...
{	echo "<tr id='t_data' bgcolor='#FFFFFF'><td colspan='4' align='center'>Data tidak ada</td></tr>";	}
	...
	while($data= fetch($qry)) {
		...
		<tr id='t_data' bgcolor='$bg'>
			...
			<td>$data[lokasi_block]</td>
			<td>$data[jumlah_sekat]</td>
			<td align='center'>";?>
				<img src="style/edit.png" class="btn" width="25" height="25" title="Edit Data" 
                	 onClick="halaman('page/lokasi_edit.php?id=<?php echo $data['0'];?>')"/> 
  				<img src="style/delete.png" class="btn" width="25" height="25"  title="Hapus Data" 
                	 onClick="konfirmasi('<?php echo $data['1'];?>','page/lokasi_hapus.php?id=<?php echo $data['0'];?>')"/> <?php 	echo "
			</td>
		</tr>";
		$i++;
	}
